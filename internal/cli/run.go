...
func runCommand(cmd *cobra.Command, args []string) error {
	...
	// Autofix: ensure the Incus bridge is in the firewalld trusted zone
	// *before* launching the container. Without this, DHCP replies are
	// dropped and the container never gets an IP.

"""
Test for coi image publish with --compression flag.

Tests that:
1. Launch and stop a container
2. Publish container as image with --compression none
...
def test_publish_with_compression_none(coi_binary, cleanup_containers, workspace_dir):
    """
    Test publishing a container as image with --compression none.

    Flow:
    1. Launch a container
    2. Stop the container
    3. Publish as image with --compression none
    ...
    test_image_name = f"test-publish-compression-{container_name}"
    ...
    # === Phase 3: Publish as image with --compression none ===
    ...
    result = subprocess.run(
        [
            ...
            test_image_name,
            "--description",
            "Test image with compression none",
            "--compression",
            "none",
        ],
        capture_output=True,

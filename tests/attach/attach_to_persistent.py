...
def test_attach_to_persistent(coi_binary, cleanup_containers, workspace_dir):
    ...
    2. Exit claude and bash (container stays running)
    3. Attach to container
    4. Verify we can interact
    5. Cleanup
    """
    ...
    # === Phase 2: Exit (container stays running in persistent mode) ===
    ...
    assert container_name in containers, \
        f"Persistent container {container_name} should still be running after exit"
    ...
    # We should reconnect to tmux session
